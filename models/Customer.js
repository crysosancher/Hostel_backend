...
`;
    ...
    VALUES 
    (CUSTOMER_ID_SEQ.NEXTVAL, :userName, 'USER', :dob, :mobile, :emailId, :adhaar, :pan, :address, :studentInd, :workAddress, TO_DATE(:startDate, 'YYYY-MM-DD'), TO_DATE(:endDate, 'YYYY-MM-DD'), :noticeInd, :bedNo, 'Y', SYSDATE, :createdBy, SYSDATE, :createdBy, :roomNo, :rent, :emergencyNo, :roomType)`;
  ...
  static async getAllCustomers() {
    const conn = await db();
    const sql = `SELECT * FROM CUSTOMERS order by LAST_UPDATED DESC`;
